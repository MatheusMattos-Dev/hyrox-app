    ...
    <main className="px-5 pt-10 pb-12">
      ...
      <section className="mt-6 flex items-center gap-4">
        {viewer?.avatarUrl ? (
          ...
          <span className="display flex h-14 w-14 items-center justify-center rounded-full bg-ink text-[24px] text-paper">
      ...
      <section className="mt-8">
        <p className="flex items-baseline gap-2">
          ...
          <span className="text-[15px] text-graphite">de {progress.total} aulas concluídas</span>
        </p>
        <div className="mt-3">
      ...
      {lessons.length > 0 ? (
        <section className="mt-9">
          <h2 className="rotulo border-b border-ink pb-1.5 text-[12px]">O ano inteiro</h2>
          <div className="mt-4">
      ...
      <section className="mt-9">
        <h2 className="rotulo border-b border-ink pb-1.5 text-[12px]">Por bloco</h2>
        <ul className="mt-4">
          {modules.map((module) => (
      ...
      {viewer?.isDemo ? (
        <p className="mt-8 border border-line bg-paper-alt p-4 text-[14px] leading-relaxed text-graphite">
      ...
      <form action="/auth/signout" method="post" className="mt-8">
        <button
          type="submit"
          className="rotulo w-full border border-line px-5 py-4 text-[13px] text-graphite"
        >
          Sair da conta
        </button>
      </form>
